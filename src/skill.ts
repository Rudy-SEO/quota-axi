...
export const SKILL_DESCRIPTION =
  "Report local Claude, Codex, Cursor, GitHub Copilot, Grok, Kimi, Z.AI, Alibaba, OpenCode Go, OpenRouter, and Antigravity quota windows via the quota-axi CLI - remaining " +
